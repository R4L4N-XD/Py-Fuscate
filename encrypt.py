...
def encode(source:str) -> str:
    ...
    marshal_encode = marshal.dumps(compile(source, 'Py-Fuscate', 'exec'))
...
def update():
    if '.git' in os.listdir():
        ...
        latest_source = requests.get('https://raw.githubusercontent.com/R4L4N-XD/Py-Fuscate/main/encypt.py').content
